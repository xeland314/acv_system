    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clase', models.CharField(help_text='Clase del vehículo.', max_length=50, verbose_name='Clase de vehículo')),
                ...
                ('valor_unidad_carburante', models.DecimalField(decimal_places=4, help_text='Valor de la unidad de carburante del vehículo.', max_digits=12, verbose_name='Valor unidad carburante')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_de_caducidad', models.DateField(help_text='La fecha de caducidad de la licencia.', validators=[vehiculos.validators.validar_vigencia_licencia])),
                ('puntos', models.PositiveSmallIntegerField(help_text='Puntos vigentes de la licencia.')),
                ('conductor', models.OneToOneField(help_text='Conductor al que pertenece esta licencia.', on_delete=django.db.models.deletion.CASCADE, related_name='licencias_conductores', to='usuarios.perfilusuario')),
            ],
        ),
        migrations.CreateModel(
            name='Kilometraje',
