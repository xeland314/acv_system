    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Administrador', 'ADMINISTRADOR'), ('Conductor', 'CONDUCTOR'), ('Encargado', 'ENCARGADO'), ('Propietario', 'PROPIETARIO'), ('Secretario', 'SECRETARIO'), ('Supervisor', 'SUPERVISOR')], help_text='Rol de un usuario en el sistema.', max_length=30, verbose_name='Rol')),
