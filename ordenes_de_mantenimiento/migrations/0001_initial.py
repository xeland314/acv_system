    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conductor', models.ForeignKey(help_text='El conductor que va a conducir el vehículo de la orden de apertura.', on_delete=django.db.models.deletion.PROTECT, related_name='aperturas_conductor', to='usuarios.perfilusuario')),
                ...
                ('responsable', models.ForeignKey(help_text='Responsable de emitir la orden de mantenimiento', on_delete=django.db.models.deletion.PROTECT, related_name='aperturas_responsables', to='usuarios.perfilusuario')),
