...
class TrabajadorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        model = Trabajador
        fields = (
            'empresa', 'nombres', 'apellidos', 'cedula', 'email', 'direccion',
    ...
    def create(self, validated_data: dict):
        ...
        usuario = Trabajador.objects.create(user=user, **validated_data)
        return usuario
...
class RepresentanteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        model = Representante
        fields = (
            'empresa', 'nombres', 'apellidos', 'cedula', 'ruc', 'email', 'direccion',
            'telefono', 'fecha_nacimiento', 'nivel_educacion',
            'estado_civil', 'contrasena', 'contrasena2', 'fotografia'
        )
        read_only_fields = ('id',)
