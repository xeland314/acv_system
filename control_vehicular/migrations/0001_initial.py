...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('operaciones', models.ManyToManyField(help_text='Las operaciones de mantenimiento a realizar en el vehículo.', to='control_vehicular.operacion')),
                ('vehiculo', models.OneToOneField(help_text='El vehículo al que pertenece la hoja de mantenimiento.', on_delete=django.db.models.deletion.CASCADE, to='control_vehicular.vehiculo')),
            ],
        ),
        migrations.CreateModel(
            name='Conductor',
